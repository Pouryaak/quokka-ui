import{e}from"./iframe-uaXos3B3.js";import{I as a}from"./Input-C-z6vDmh.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CE2vBQ91.js";import"./bundle-mjs-BJeS7sC5.js";const S={title:"Components/Input",component:a,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:["Text input with outline/subtle variants, sizes, and built-in a11y wiring.","","**A11y**","- Provide a visible `label` or an `aria-label` when label is omitted.","- `error` shows an error message and sets `aria-invalid` + `aria-errormessage`.","- `helperText` is referenced via `aria-describedby` when no error."].join(`

import{e}from"./iframe-B0LassJS.js";import{I as a}from"./Input-BsLE3whf.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B8k91cqS.js";import"./clsx-B-dksMZM.js";import"./bundle-mjs-Ct12j0u0.js";const T={title:"Components/Input",component:a,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:["Text input with outline/subtle variants, sizes, and built-in a11y wiring.","","**A11y**","- Provide a visible `label` or an `aria-label` when label is omitted.","- `error` shows an error message and sets `aria-invalid` + `aria-errormessage`.","- `helperText` is referenced via `aria-describedby` when no error."].join(`
...
}`,...p.parameters?.docs?.source}}};const f=["Default","OutlineVsSubtle","Sizes","WithHelperText","WithError","Required","Disabled","AriaLabelOnly","Controlled"];export{d as AriaLabelOnly,p as Controlled,t as Default,c as Disabled,l as OutlineVsSubtle,i as Required,s as Sizes,o as WithError,n as WithHelperText,f as __namedExportsOrder,T as default};

import{e}from"./iframe-C1cBllBT.js";import{T as a}from"./Tabs-CYAK-E7o.js";import{P as o,C as T,G as d,R as b}from"./react-icons.esm-D7cXR5Ir.js";import"./preload-helper-PPVm8Dsz.js";import"./bundle-mjs-BMK1rqe9.js";import"./jsx-runtime-BqEL6l6U.js";import"./index-CqQ0AAJX.js";const N={title:"Components/Tabs",component:a,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:["Tabs built on Radix with `pill` and `underline` variants and `sm/md/lg` sizes.","Radix provides roles/keyboard; this wrapper controls visuals via tokens."].join(`
...
}`,...u.parameters?.docs?.source}}};const z=["Default","VariantComparison","WithIcons","Sizes","WithDisabled","Controlled"];export{u as Controlled,r as Default,i as Sizes,l as VariantComparison,c as WithDisabled,s as WithIcons,z as __namedExportsOrder,N as default};
